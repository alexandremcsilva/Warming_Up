...
void MenuSurfer(int* T, int* ano, int* months, int* aux_df, int* aux_ms, int* _auxth, char place_in_analysis[BUFFER_SIZE], int* _auxyta){
...
void YearTempAnalise(int* ano, int* _auxyta){
